...
*/
    ...
    static void exper(String string, String filename1, String filename2 ) throws IOException {
        ...
        try(FileWriter file = new FileWriter(filename1); FileWriter file1 = new FileWriter(filename2)){
           ...
           int  N = 50;
            ...
            System.out.println("Ќахождение второго прообраза(среднее) дл€ 4 бит " + counter / 1000);
            System.out.println("Ќахождение коллизий(среднее) дл€ 4 бит " + counter1 / 1000);
            ...
            System.out.println("Ќахождение второго прообраза(среднее) дл€ 6 бит " + counter / 1000);
            System.out.println("Ќахождение коллизий(среднее) дл€ 6 бит  " + counter1 / 1000);
            ...
            System.out.println("Ќахождение второго прообраза(среднее) дл€ 8 бит " + counter / 1000);
            System.out.println("Ќахождение коллизий(среднее) дл€ 8 бит  " + counter1 / 1000);
            ...
            System.out.println("Ќахождение второго прообраза(среднее) дл€ 10 бит  " + counter / 1000);
            System.out.println("Ќахождение коллизий(среднее) дл€ 10 бит  " + counter1 / 1000);
            ...
            System.out.println("Ќахождение второго прообраза(среднее) дл€ 12 бит  " + counter / 1000);
            System.out.println("Ќахождение коллизий(среднее) дл€ 12 бит  " + counter1 / 1000);
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("--------------------------------------------------------EXPERIMENT --------------------------------------------------------");
        System.out.println("Ёксперимент дл€ первого код-слова:");
        System.out.println("mother");
        exper("mother","col1","proobraz1");
        System.out.println("--------------------------------------------------------EXPERIMENT --------------------------------------------------------");
        System.out.println("Ёксперимент дл€ второго код-слова:");
        System.out.println("00000");
        exper("00000","col3","proobraz3");
        System.out.println("--------------------------------------------------------EXPERIMENT --------------------------------------------------------");
        System.out.println("Ёксперимент дл€ третьего код-слова:");
